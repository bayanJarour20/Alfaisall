  ...
  >
    ...
    >
      <component
        ...
        :key="layoutContentRenderer === 'layout-content-renderer-left' ? (typeof $route.meta == 'function' ? $route.meta($route).navActiveLink : '') || $route.name : null"
      >
    ...
    layoutContentRenderer() {
      let rendererType
        if(typeof this.$route.meta == "function") {
            rendererType = this.$route.meta(this.$route).contentRenderer
        } else {
            rendererType = this.$route.meta.contentRenderer
        }
